...
void InstrumentController::manual_adjustment()
{
  ...
  for (;;)
  {
    ...
    RCLCPP_INFO(logger_, "Current positions: [%d, %d, %d, %d]", current_positions[0], current_positions[1],
    ...
    switch (c)
    {
      ...
      case KEYCODE_5:
        ...
        gearbox.motor_controller.send_relative_motor_positions(0, gearbox.get_pulses_per_rotation(1),
                                                               gearbox.get_pulses_per_rotation(2), 0);
        break;
      case KEYCODE_6:
