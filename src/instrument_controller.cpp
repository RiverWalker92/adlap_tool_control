...
int InstrumentController::get_motor2_value_for_angle(double radians, bool verbose)
{
  ...
  int current_difference =
      motor_controller_.get_positions()[2] - motor_controller_.get_positions()[1] - starting_difference -
      bend_play_compensation_;  // Current difference between motor 2 and motor 1, compensated for play
